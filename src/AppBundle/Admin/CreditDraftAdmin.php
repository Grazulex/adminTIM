...
class CreditDraftAdmin extends AbstractAdmin
{
    protected $baseRoutePattern = 'credit-draft';
    protected $baseRouteName = 'credit_draft';
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper
            ...
            'actions' => array(
                ...
                'Open' => array(
                    'template' => 'AppBundle:Credit:list__action_open.html.twig'
                ),                  
                'Send' => array(
